set_property SRC_FILE_INFO {cfile:D:/Vivado_designs/nano_processor_V1/Basys3Labs_Nano_processor_v1.xdc rfile:../../../Basys3Labs_Nano_processor_v1.xdc id:1} [current_design]
...
set_property PACKAGE_PIN P3 [get_ports {Flag_Sign}]
set_property src_info {type:XDC file:1 line:73 export:INPUT save:INPUT read:READ} [current_design]
set_property PACKAGE_PIN N3 [get_ports {Flag_overflow}]
set_property src_info {type:XDC file:1 line:75 export:INPUT save:INPUT read:READ} [current_design]
set_property PACKAGE_PIN P1 [get_ports {Flag_Zero}]
set_property src_info {type:XDC file:1 line:77 export:INPUT save:INPUT read:READ} [current_design]
set_property PACKAGE_PIN L1 [get_ports {Flag_C_out}]
